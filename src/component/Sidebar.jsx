...
const Sidebar = () => {
    return (
        <div className='sidebar flex-1 bg-primary min-h-screen'>
            <div className="top h-12 flex items-center justify-center mt-12 mb-20">
                <Link to="/">
                    <span className='logo text-xl font-bold text-white'>AdminApp</span>
                </Link>
            </div>
                ...
                <ul>
                    ...
                    <Link to="/users">
                        <li className='li-list'>
                            ...
                            <span className='li-label'>Members</span>
                        </li>
                    </Link>
